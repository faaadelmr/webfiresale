...
export default function OAuthButtons({ callbackUrl }: OAuthButtonsProps) {
  ...
  return (
    <div className="space-y-3">
      ...
      {authSettings.providers.facebook && (
        <button
      ...
      {authSettings.providers.instagram && (
        <button
        ...
        >
          <svg
            ...
            className="w-5 h-5"
          >
            <radialGradient id="radial-gradient-instagram" cx="0.25" cy="0.25" r="0.75" fx="0.25" fy="0.25">
              <stop offset="0%" stopColor="#feda75" />
              <stop offset="25%" stopColor="#fa7e1e" />
              <stop offset="50%" stopColor="#d62976" />
              <stop offset="75%" stopColor="#4f5bd5" />
              <stop offset="100%" stopColor="#7c3699" />
            </radialGradient>
            <path
              ...
              fill="url(#radial-gradient-instagram)"
            />
          </svg>
